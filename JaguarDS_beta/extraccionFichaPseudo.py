...
autonomia_df = pd.read_excel('autonomias_pseudoanonimizado.xlsx')
entrenamiento_df = pd.read_excel('entrenamiento_pseudoanonimizado.xlsx')

# Convertir las columnas de fecha a tipo datetime
entrenamiento_df['Fecha Vence'] = pd.to_datetime(entrenamiento_df['Fecha Vence'], format='%Y-%m-%d')
autonomia_df['Fecha fin'] = pd.to_datetime(autonomia_df['Fecha fin'], format='%Y-%m-%d')
